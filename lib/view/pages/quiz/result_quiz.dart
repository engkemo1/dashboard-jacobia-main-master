                                        ...
                                        content: Container(
                                          ...
                                          child: Column(
                                            children: [
                                              ...
                                              Text(
                                                  'Type Coins: ${widget.data['typeCoins']}'),
                                              SizedBox(
                                                height: 20,
                                              ),
                                              TextField(
                                                ...
                                                controller: prizeController
                                                  ..text = (widget.data[
                                                              'Rank${index == 9 ? 1 : index == 8 ? 2 : index == 7 ? 3 : index == 6 ? 4 : index == 5 ? 5 : index == 4 ? 6 : index == 3 ? 7 : index == 2 ? 8 : index == 1 ? 9 : index == 0 ? 10 : 0}'] *
                                                          total /
                                                          100)
                                                      .toString(),
                                              ),
                                                      ...
                                                      style: ElevatedButton
                                                          .styleFrom(
                                                              primary: Colors
                                                                  .greenAccent),
                                                      onPressed: () {
                                                        var coin=widget.data['typeCoins'];
